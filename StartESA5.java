...
// creates file for 8X original grid spacing
...
public class StartESA5 {
	...
	public double q = -1.0;
	public String filename = "D2f_ESA8_small.ion";
	...
	public StartESA5() {
		...
		while ((line=inF.readLine())!=null) {
			...
			if (el>-9.0 && el<5.0 && rad>35.75 && rad<44.75 && rad2>31.8 && rad2<46.9 && ran2<1.0) {
				outF.write(0.0+", "+ m +", "+q+", "+((startX+1)*gridsPerMM) +", "+rad*gridsPerMM + ", "
