...
public class StartESA1 {
	...
	public double q = -1.0;
	public String filename = "fromESA8_filter.ion";
	...
	public StartESA1() {
		...
		while ((line=inF.readLine())!=null) {
			...
			if (el>-9.0 && el<5 && rad>35.75 && rad<44.75 /*&& ran2<0.1*/) {
				outF.write(0.0+", "+ m +", "+ q +", " + startX +", " + rad*gridsPerMM+", "
			                 + 0.0 +", "+az_e+", "+el_e+", "+ev+", "+cwf+", "+pen+"\n");
			}
			else {
				counterMiss++;
			}
