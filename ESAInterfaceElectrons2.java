...
*
*/
public class ESAInterfaceElectrons2  {
	...
	public ESAInterfaceElectrons2() {
		...
		// negative hydrogen from esa interface
		x=41.9;
		y=29.3;
		for (int i=0; i<n; i++) {
			//x += (42.0-37.5)/(double)n;
	...
	*/
	...
	public static void main(String[] args) {
		ESAInterfaceElectrons2 se = new ESAInterfaceElectrons2();
	}
}