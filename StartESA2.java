...
*
*/
public class StartESA2 {

	public int n = 350;
	public double startX = 28;
	...
	public double q = -1.0;
	public String filename = "2f_fromESA8_small_2b.ion";
	public String inputFileName = "ak7_20kV_mp33mm_bin8_splat.log.splat";
	...
	public StartESA2() {
		...
		while ((line=inF.readLine())!=null) {
			...
			if (el>-9.0 && el<5 && rad>35.75 && rad<44.75 && rad2>31.3 && rad2<47.2 && ran2<0.1) {
				outF.write(0.0+", "+ m +", "+q+", "+startX*gridsPerMM+4.0 +", "+rad2*gridsPerMM+", "
	...
	*/
	public double nextEnergy() {
		...
		double energy = r.nextDouble()*20.0;
		while (homeMadeFunction(energy)<ran) {
    		ran = r.nextDouble();
			energy = r.nextDouble()*20.0;
		}
		return energy;
	}
