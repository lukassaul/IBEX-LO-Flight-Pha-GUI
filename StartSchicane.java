...
*
*/
public class StartSchicane {

	public int n = 500;
	public double startX = 200.0;
	public double minY = 44.0;
	public double maxY = 55.0;
	public double yMid = 49.5;
	...
	public double m = 40;
	public double q = +1.0;
	public String filename = "start_schicane.ion";
	...
	*/
	...
	public static void main(String[] args) {
		StartSchicane se = new StartSchicane();
	}
}